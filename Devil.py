...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕DJ  PS▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕DJ PS▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mDevilJutt.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mDevilJutt\033[1;91m...............
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    st.close()
		    print (S + '[☆]' + Y + ' Login successfull 100% ✓DJ')
		    os.system('xdg-open https://www.facebook.com/devil.jutt301')
		    menu()
		else:
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/DEVIL JUTT 👿')
	    os.system('cd $HOME && git clone https://github.com/deviljutt301')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
